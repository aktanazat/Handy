{
  description = "Sona is a local-first desktop speech-to-text app";
  ...
  outputs =
    ...
    in
    {
      packages = forAllSystems (
        ...
        in
        {
          sona = pkgs.rustPlatform.buildRustPackage {
            pname = "sona";
            inherit version;
            src = self;
          ...
          default = self.packages.${system}.sona;
        }
      );
      ...
      nixosModules.default =
        { lib, pkgs, ... }:
        {
          ...
          programs.sona.package = lib.mkDefault self.packages.${pkgs.stdenv.hostPlatform.system}.sona;
        };
      ...
      homeManagerModules.default =
        { lib, pkgs, ... }:
        {
          ...
          services.sona.package = lib.mkDefault self.packages.${pkgs.stdenv.hostPlatform.system}.sona;
        };
      ...
      devShells = forAllSystems (
        ...
        in
        {
          default = pkgs.mkShell {
            ...
            shellHook = ''
              echo "Sona development environment"
              bun install
